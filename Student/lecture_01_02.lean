...
/-!
Questions:
- Which two types are equivalent? #1 & #2
- Are #1 and #3 equivalent? NO, because → is right associative. #1 is a function that takes a function as an arg and returns a string,
#3 is a function that takes two strings as an argument and returns a string
- Give English explanations of these function types
#1 a function that takes a function which maps String to String, and returns a string
#2 takes a string as a function and returns a function which takes a string an returns a string
#3 takes two strings as an arguments and returns a string, equivalent to #2
- Give some examples of functions of these types
#1 a function that returns the name of a function
#2 append function
#3 append function
`-/

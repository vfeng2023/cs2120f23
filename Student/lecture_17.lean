...
/-
A proof of ¬ P is proof of P → False
- Creates contradiction that can only resolved if P is False
-/
example (P:Prop) : ¬ (P ∧ ¬ P):= -- (P ∧ ¬ P) → False
...
/-!
Law of the excluded middle -- an axiom true in first order predicate logic and traditional logic
-/

...
| Expr.top_exp => 0 --return 0 since they should not count towards the total variable count
| Expr.bot_exp => 0
...
→ List β 
| _, [] => []
| converter, h::t => (converter h) :: (map converter t)
